...
const items:AccordionType[] = [
    {
        ...
        content: `Мы  знаем как <h2>купить Udemy из России. </h2> Наш сервис позволяет оплатить любимые курсы или оформить подписку на сайте Udemy.com, если у вас  карта российского банка.` ,
    },
    {
        id: 2,
