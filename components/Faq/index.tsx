...
const items: AccordionType[] = [
    ...
    },
    {
        ...
        content: `Самые надежная гарантия - это отзывы моих покупателей. Все отзывы написаны реальными людьми с открытыми контактами. Кроме того вы можете найти меня в социальных сетях и связаться со мной.`,
    },
    {
        id: 2,
