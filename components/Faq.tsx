...
const items:AccordionType[] = [
    ...
    },
    {
        ...
        content: `В этом случае вам нужно предоставить доступ к данному аккаунту нам, сообщив логин и пароль. Но лучше завести новый.` ,
    },
    {
        id: 5,
        title: `Как оплатить курсы российской картой?`,
        content: `Расчет производиться в рублях, предоплатой на ... ДОРАБОТАТЬ ТЕКСТ` ,
    },
    {
        id: 6,
        title: `Как рассчитывается стоимость курса в рублях?`,
        content: `Из конвертации доллара к рублю по курсу ЦБ плюс комиссия за предоставление услуги. <br/> ПЕРЕРАБОТАТЬ ТЕКСТ. Мы просто берем столько же, сколько Udemy просит в рублях плюс мб комиссия юмани ` ,
    },
    {
        id: 7,
